...
def download_files(cookies_from_db, saving_path, include_messaging, include_audio):
    ...
    contacts_api = 'https://alexa-mobile-service-na-preview.amazon.com/users/amzn1.comms.id.person.amzn1~amzn1.account.AHP3QR64GFO24DGHVS3CXJ7NUIXQ/contacts'
    conversations_api = 'https://alexa-mobile-service-na-preview.amazon.com/users/amzn1.comms.id.person.amzn1~amzn1.account.AHP3QR64GFO24DGHVS3CXJ7NUIXQ/conversations' 
    single_conversation = ''
    base_api = 'https://alexa-mobile-service-na-preview.amazon.com/users/'
    
    
    #call the fucntion/method to save to the local disk
